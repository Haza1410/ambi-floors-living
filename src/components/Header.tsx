        ...
        <Container className="flex items-center justify-between gap-4 py-2 text-xs">
          <div className="flex items-center gap-5">
            <span className="flex items-center gap-1.5">
              ...
              610 Walsall Road, Great Barr, Birmingham
            </span>
            <span className="flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-5">
            <span className="text-background/60">Supply &amp; fitting across Birmingham &amp; the West Midlands</span>
            <a
          ...
          <Container className="py-3">
            <div className="flex flex-col gap-1">
              ...
              <div className="mt-2 flex items-center gap-2 rounded-lg bg-surface px-3 py-3 text-sm text-muted">
                ...
                610 Walsall Road, Great Barr, B42 1EZ
              </div>
              <a
                href={contact.phoneHref}
