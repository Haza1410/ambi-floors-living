        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-background/70">
              An independent flooring and home interiors showroom in Great Barr,
              Birmingham. Carpets, LVT, laminate, vinyl, rugs and furniture — with
              honest advice and professional fitting.
            </p>
            <a
