  ...
  return (
    <>
      <Hero
        ...
        description="We'd love to hear from you. Visit our Great Barr showroom, give us a call, or send an email — our team is ready to help with expert advice and free quotes."
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="mt-4 text-muted">
                  Pop into our showroom to browse our full range, or contact us to
                  discuss your project and arrange a free quote.
                </p>
              </div>
                ...
                <div className="flex items-start gap-4 border border-border p-6">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs text-muted">
                      Call us for expert advice and free quotes
                    </p>
                  </div>
                </div>
      ...
      <section className="bg-surface py-16">
        <div className="mx-auto w-full max-w-3xl px-4 text-center lg:px-5">
          ...
          <p className="mt-4 text-muted">
            We welcome customers from Great Barr, Sutton Coldfield, Erdington,
            Kingstanding, Walsall, and surrounding areas. Visit our showroom or
